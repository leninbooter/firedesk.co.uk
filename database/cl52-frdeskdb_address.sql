...
CREATE TABLE `address` (
  ...
  `Supplier_Credit_Limit` float DEFAULT NULL,
  `Days_sup` int(11) DEFAULT NULL,
  `Customer_Credit_Limit` float DEFAULT NULL,
  `Days_cust` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2014-11-26 17:38:44
