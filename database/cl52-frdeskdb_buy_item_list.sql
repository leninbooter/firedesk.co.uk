...
--
-- Table structure for table `buy_item_list`
--

DROP TABLE IF EXISTS `buy_item_list`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `buy_item_list` (
  ...
  `Arrived` text COLLATE utf8_unicode_ci,
  `Returned` text COLLATE utf8_unicode_ci,
  `P_Invoice` text COLLATE utf8_unicode_ci,
...
-- Dump completed on 2014-11-26 17:38:43
