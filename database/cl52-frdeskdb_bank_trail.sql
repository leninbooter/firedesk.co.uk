...
--
-- Table structure for table `bank_trail`
--

DROP TABLE IF EXISTS `bank_trail`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bank_trail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Reference` text COLLATE utf8_unicode_ci NOT NULL,
  `Description` text COLLATE utf8_unicode_ci,
  `Bank_Code` text COLLATE utf8_unicode_ci NOT NULL,
  `Debit` float DEFAULT NULL,
  `Credit` float DEFAULT NULL,
  `Date` text COLLATE utf8_unicode_ci,
  `Reconciled` tinyint(1) NOT NULL DEFAULT '0',
  `Reconciliation_Date` text COLLATE utf8_unicode_ci,
...
-- Dump completed on 2014-11-26 17:38:47
