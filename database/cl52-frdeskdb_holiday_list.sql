...
CREATE TABLE `holiday_list` (
  ...
  `Holiday` text COLLATE utf8_unicode_ci NOT NULL,
  `Date_Start` text COLLATE utf8_unicode_ci,
  `Date_End` text COLLATE utf8_unicode_ci,
  `Affects_Hiring` tinyint(1) DEFAULT '0',
...
-- Dump completed on 2014-11-26 17:39:00
