...
--
-- Table structure for table `sales_invoces`
--

DROP TABLE IF EXISTS `sales_invoces`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sales_invoces` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Inv_No` text COLLATE utf8_unicode_ci NOT NULL,
  `Customer` text COLLATE utf8_unicode_ci NOT NULL,
  `Invoiced` text COLLATE utf8_unicode_ci NOT NULL,
  `Paid` text COLLATE utf8_unicode_ci,
  `Net_to_pay` float DEFAULT NULL,
  `VAT` float DEFAULT NULL,
  `Gross_to_pay` float DEFAULT NULL,
...
-- Dump completed on 2014-11-26 17:38:56
