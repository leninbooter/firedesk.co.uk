...
<div class="row">
	<div class="col-md-6"><h1>New Purchase Order</h1></div>
	<div class="col-md-6"></div>
</div>
<form id="generate_purchase_order_form" role="form" method="post" action="<?php echo base_url('index.php/purchases_orders/generate_order'); ?>">
	<div class="row">
		<div class="col-md-9">
			<div class="row">
				<div class="col-md-4">
