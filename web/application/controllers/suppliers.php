...
class Suppliers extends CI_Controller
{
	...
	public function new_existing()
	{
		...
		{
			$this->load->model('suppliers_m');
			$data['supplier'] = $this->suppliers_m->get_supplier_details($pk_id);
			$data['editing'] = true;
		}
			
		$this->load->view('header_nav');
		if( isset($data['supplier']) ) $this->load->view('new_existing_supplier', $data);
			else	$this->load->view('new_existing_supplier');
